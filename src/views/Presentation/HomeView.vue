<script setup>
  ...
  import PresentationHomeGame from "./Sections/PresentationHomeGame.vue";
...
<template>
  ...
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    ...
    <div class="row w-80 m-auto my-6">
      <h3 class="mb-4">New Games</h3>
      <PresentationHomeGame />
    </div>

    <div class="row w-80 m-auto my-6">
      <h3 class="mb-4">Tournaments</h3>
      <PresentationHomeGame />
    </div>
  </div>
  <DefaultFooter />
