...
import HomeView from "../views/Presentation/HomeView.vue";
import PresentationGame from "../views/Presentation/Sections/PresentationGame.vue"
import AboutView from "../views/LandingPages/AboutUs/AboutView.vue";
import ContactView from "../views/LandingPages/ContactUs/ContactView.vue";
import AuthorView from "../views/LandingPages/Author/AuthorView.vue";
import SignInBasicView from "../views/LandingPages/SignIn/BasicView.vue";
import LoginView from "../views/LandingPages/SignIn/Login.vue";
import SignupView from "../views/LandingPages/SignIn/Signup.vue";
...
import GameDetailView from "../views/GameDetail/GameDetailView.vue";
import PlayUnityView from "../views/GameDetail/PlayUnityView.vue";
  ...
  routes: [
    ...
    },
    {
      ...
      beforeEnter: (to, from, next) => {
        useLoginStore().checkLogin() ? next('/') : next()
      }
    },
    {
      path: "/signup-view",
...

    {
      path: '/game/play/:id',
      name: 'play-unity',
      component: PlayUnityView,
      beforeEnter: (to, from, next) => {
        useLoginStore().checkLogin() ? next() : next('/login-view')
      }
    },
